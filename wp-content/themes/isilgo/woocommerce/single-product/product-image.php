<?php global $product; ?>
<div class="muestra_imagen_mobile">
...
<div class="by">
	...
	if ($autores) { ?>
		<div class="centra_compartir">
			<button class="compartir_custom_mobile">
				<img src="<?php echo get_bloginfo('template_directory'); ?>/assets/img/compartir.svg" alt=""> Compartir
			</button>
			<div class="comparte_hide"><?php echo do_shortcode('[Sassy_Social_Share]'); ?></div>
		</div>
		<?php
...
?>
	<div class="rating_single">
		<ul>
			...
			<li>
				<p class="share_pdp">Compartir en:</p> <?php echo do_shortcode('[Sassy_Social_Share]'); ?>
			</li>
		</ul>
	</div>
<?php } ?>
...
?>
	<div class="row">
		<div class="col-12 valoracion_curso">
			<h2>Valoración del curso</h2>
		</div>
		<div class="col-xl-3 col-12 rating_grande">
