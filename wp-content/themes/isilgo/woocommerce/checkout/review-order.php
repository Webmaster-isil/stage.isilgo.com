...
?>
<table class="tabla_especial_finalizar shop_table woocommerce-checkout-review-order-table">
							...
							<div class="col-md-9">
								<div class="alinea_carrito">
									<div>
										...
										$author = $cart_item['data']->post->post_author;

										if (!in_array(24, $_product->get_category_ids())) { ?>
											<div class="dictado_por">Dictado por <span><?php echo the_author_meta('display_name', $author); ?></span></div>
										<?php }
										?>
									...
									<?php echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><img src="' . get_bloginfo('template_directory') . '/assets/img/trash.svg"></a>',
	...
	<tfoot>
		<tr>
			<td colspan="2"><img class="w-75" src="<?php echo get_bloginfo('template_directory'); ?>/assets/img/pagos.png" alt="Medios de pago"></td>
		</tr>
