...
?>
<div class="compra_revisa">



	<?php
	do_action('woocommerce_review_order_before_cart_contents');
	echo '<ul class="contenido_carrito row">';
	...
	<img src="<?php echo get_bloginfo('template_url'); ?>/assets/img/pagos.png" alt="">
	<table class="totales_review">
